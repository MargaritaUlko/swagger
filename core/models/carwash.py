...
class Service(Base):  # Изменил Services на Service
    ...
    price = Column(Integer)
    time = Column(Integer)
    order_services = relationship("OrderService",
                                  back_populates="service")  # "service" is the forward relationship in OrderService
...
class OrderService(Base):
    ...
    service = relationship("Service",
                           back_populates="order_services")  # "order_services" is the reverse relationship in Service
...
class Order(Base):
    ...
    order_services = relationship("OrderService",
                                  back_populates="order")  # "order" is the forward relationship in OrderService
